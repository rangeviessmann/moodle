...
/**
 * Test helpers for the filepicker question type.
 *
...
/**
 * Test helper class for the filepicker question type.
 *
 * @copyright  2013 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_filepicker_test_helper extends question_test_helper {
     ...
     * @return qtype_filepicker_question
     */
    protected function initialise_filepicker_question() {
        question_bank::load_question_definition_classes('filepicker');
        $q = new qtype_filepicker_question();
        test_question_maker::initialise_a_question($q);
        $q->name = 'Filepicker question (HTML editor)';
        ...
        $q->qtype = question_bank::get_qtype('filepicker');

        return $q;
    }

    /**
     * Makes an filepicker question using the HTML editor as input.
     * @return qtype_filepicker_question
     */
    public function make_filepicker_question_editor() {
        return $this->initialise_filepicker_question();
    }

    /**
     * Make the data what would be received from the editing form for an filepicker
     ...
     */
    public function get_filepicker_question_form_data_editor() {
        $fromform = new stdClass();

        $fromform->name = 'Filepicker question (HTML editor)';
    ...
    /**
     * Makes an filepicker question using the HTML editor allowing embedded files as
     * input, and up to three attachments.
     * @return qtype_filepicker_question
     */
    public function make_filepicker_question_editorfilepicker() {
        $q = $this->initialise_filepicker_question();
     ...
     * @return qtype_filepicker_question
     */
    public function make_filepicker_question_editorfilepickertworequired() {
        $q = $this->initialise_filepicker_question();
        $q->responseformat = 'editorfilepicker';
        $q->attachments = 2;
     ...
     * @return stdClass the data that would be returned by $form->get_gata();
     */
    public function get_filepicker_question_form_data_editorfilepicker() {
        $fromform = new stdClass();

        $fromform->name = 'Filepicker question with filepicker and attachments';
        $fromform->questiontext = array('text' => 'Please write a story about a frog.', 'format' => FORMAT_HTML);
        $fromform->defaultmark = 1.0;
        $fromform->generalfeedback = array('text' => 'I hope your story had a beginning, a middle and an end.', 'format' => FORMAT_HTML);
    ...
    /**
     * Makes an filepicker question using plain text input.
     * @return qtype_filepicker_question
     */
    public function make_filepicker_question_plain() {
        $q = $this->initialise_filepicker_question();
     ...
     * @return stdClass the data that would be returned by $form->get_gata();
     */
    public function get_filepicker_question_form_data_plain() {
        $fromform = new stdClass();
    ...
    /**
     * Makes an filepicker question using monospaced input.
     * @return qtype_filepicker_question
     */
    public function make_filepicker_question_monospaced() {
        $q = $this->initialise_filepicker_question();
        $q->responseformat = 'monospaced';
        return $q;
    }

    public function make_filepicker_question_responsetemplate() {
        $q = $this->initialise_filepicker_question();
    ...
    /**
     * Makes an filepicker question without an online text editor.
     * @return qtype_filepicker_question
     */
    public function make_filepicker_question_noinline() {
        $q = $this->initialise_filepicker_question();
     ...
     * @return stdClass
     */
    public function get_filepicker_question_form_data_files() {
        global $CFG, $USER;
        $fromform = new stdClass();
        ...
        $fs->create_file_from_pathname($filerecord, $CFG->dirroot .
            '/question/type/filepicker/tests/fixtures/1.png');
        ...
        $fs->create_file_from_pathname($filerecord, $CFG->dirroot .
            '/question/type/filepicker/tests/fixtures/2.png');
        ...
        $fs->create_file_from_pathname($filerecord, $CFG->dirroot .
            '/question/type/filepicker/tests/fixtures/3.png');
