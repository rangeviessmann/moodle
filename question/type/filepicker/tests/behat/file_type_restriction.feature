...
Feature: In a filepicker question, limit submittable file types
  ...
  Background:
    ...
    And the following "questions" exist:
      ...
      | Test questions   | filepicker       | TF1   | First question  | 20          |
  ...
  @javascript
  Scenario: Preview an Filepicker question and submit a response with a correct filetype.
  ...
  @javascript
  Scenario: Preview an Filepicker question and try to submit a response with an incorrect filetype.
    Given the following "user private file" exists:
      | user     | student                             |
