...
/**
 * Testing the upgrade of filepicker question attempts.
 *
...
final class upgrade_old_attempt_data_test extends \question_attempt_upgrader_test_base {
    ...
    public function test_filepicker_deferredfeedback_history98220(): void {
        $quiz = (object) array(
            'id' => '4140',
            'course' => '5012',
    ...
    public function test_filepicker_deferredfeedback_history820(): void {
        $quiz = (object) array(
            'id' => '142',
            'course' => '187',
            'name' => 'Questionnaire',
    ...
    public function test_filepicker_deferredfeedback_missing(): void {
        $quiz = (object) array(
            'id' => '142',
            'course' => '187',
            'name' => 'Questionnaire',
