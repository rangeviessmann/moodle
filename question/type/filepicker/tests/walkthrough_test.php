...
/**
 * Unit tests for the filepicker question type.
 *
...
final class walkthrough_test extends \qbehaviour_walkthrough_test_base {
    ...
    public function test_deferred_feedback_html_editor(): void {
        ...
        // Create an filepicker question.
        $q = \test_question_maker::make_question('filepicker', 'editor');
    ...
    public function test_deferred_feedback_plain_text(): void {
        ...
        // Create an filepicker question.
        $q = \test_question_maker::make_question('filepicker', 'plain');
        $this->start_attempt_at_question($q, 'deferredfeedback', 1);
    ...
    public function test_responsetemplate(): void {
        ...
        // Create an filepicker question.
        $q = \test_question_maker::make_question('filepicker', 'responsetemplate');
        $this->start_attempt_at_question($q, 'deferredfeedback', 1);
    ...
    public function test_deferred_feedback_html_editor_with_files_attempt_on_last(): void {
        ...
        // Create an filepicker question in the DB.
        $generator = $this->getDataGenerator()->get_plugin_generator('core_question');
        $cat = $generator->create_question_category();
        $question = $generator->create_question('filepicker', 'editorfilepicker', array('category' => $cat->id));
    ...
    public function test_deferred_feedback_plain_attempt_on_last(): void {
        ...
        $generator = $this->getDataGenerator()->get_plugin_generator('core_question');
        $cat = $generator->create_question_category();
        $question = $generator->create_question('filepicker', 'plain', array('category' => $cat->id));
    ...
    public function test_deferred_feedback_word_limits(): void {
        ...
        // Create an filepicker question.
        /** @var qtype_filepicker_question $q */
        $q = \test_question_maker::make_question('filepicker', 'editor');
        $q->minwordlimit = 3;
        $q->maxwordlimit = 7;
        $this->start_attempt_at_question($q, 'deferredfeedback', 1);
