...
/**
 * Format preparation section extra logic component.
 *
 * @module     format_preparation/section
...
class HighlightSection extends BaseComponent {
    ...
    create() {
        ...
        this.name = 'format_preparation_section';
        ...
        // The preparation format section specific actions.
        this.formatActions = {
