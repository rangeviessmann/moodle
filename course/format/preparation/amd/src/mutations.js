 ...
 *
 * @module     format_preparation/mutations
...
class PreparationMutations extends DefaultMutations {
...
export const init = () => {
    ...
    courseEditor.addMutations(new PreparationMutations());
