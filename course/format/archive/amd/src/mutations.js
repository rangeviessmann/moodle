 ...
 *
 * @module     format_archive/mutations
...
class ArchiveMutations extends DefaultMutations {
...
export const init = () => {
    ...
    courseEditor.addMutations(new ArchiveMutations());
