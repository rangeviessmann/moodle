...
$string['page-course-view-archive'] = 'Any course main page in custom sections format';
$string['page-course-view-archive-x'] = 'Any course page in custom sections format';
...
$string['isseparator'] = 'Podział (separator)';
$string['isseparator_help'] = 'If set to Yes, this section acts as a visual divider / heading only. No activities can be added to it and its content is not displayed.';
