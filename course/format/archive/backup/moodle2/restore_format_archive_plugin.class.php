...
/**
 * Specialised restore for Archive course format.
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_format_archive_plugin extends restore_format_plugin {
    ...
    public function after_restore_course() {
        ...
        $backupinfo = $this->step->get_task()->get_info();
        if ($backupinfo->original_course_format !== 'archive' || !isset($data['tags']['numsections'])) {
