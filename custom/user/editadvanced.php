...
//
// Custom override of /user/editadvanced.php
// Changes: loads custom editadvanced_form.php with PESEL label and relaxed validation.
//
...
// CUSTOM: Load our custom form instead of the original.
require_once($CFG->dirroot.'/custom/user/editadvanced_form.php');
