...
/**
 * Custom override: after finishing a quiz in a preparation course,
 * redirect back to the course page instead of the quiz review page.
 *
 * @package   mod_quiz
...
if ($status == quiz_attempt::OVERDUE) {
    ...
    // If this quiz belongs to a "przygotowanie do egzaminu" course, redirect
    // straight back to the course page instead of the quiz review page.
    $courseid = $attemptobj->get_courseid();
    if ($DB->record_exists('local_recruitment_course', ['preparation_course' => $courseid])) {
